...
//test
  ...
  sketch.setup = function() {
    ...
    if((sketch.windowWidth / sketch.windowHeight) < 1.4) {
      canvasElt.style.width = '100vw', canvasElt.style.height="100%", canvasElt.style.marginTop=(sketch.windowHeight - 600)/2+"px", canvasElt.style.marginBottom=(sketch.windowHeight - 700)/2+"px";
    }
    else {
